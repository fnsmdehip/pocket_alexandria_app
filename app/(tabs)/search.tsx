...
import { searchBooks as searchCatalog, books, categoryIcons } from '../../src/data/catalog';
    ...
    <SafeAreaView style={styles.screen} edges={['top']}>
      ...
      {searching ? (
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyText}>Try different keywords or browse the collection.</Text>
        </View>
      ) : !hasSearched ? (
        <View style={styles.emptyState}>
          <Text style={styles.emptyIcon}>{'\u2315'}</Text>
          ...
          <View style={styles.suggestions}>
            ...
            {['Hermes', 'Stoicism', 'Alchemy', 'Plato', 'Soul', 'Wisdom'].map(term => (
              <TouchableOpacity
                key={term}
...
const styles = StyleSheet.create({
  ...
  searchInputContainer: {
    ...
    borderWidth: 1, borderColor: colors.surfaceBorder, paddingHorizontal: 12, height: 44,
  },
  searchIcon: { fontSize: 18, color: colors.textMuted, marginRight: 8 },
  searchInput: { flex: 1, ...fonts.sansRegular, fontSize: 15, color: colors.textPrimary, height: 44 },
  clearBtn: { padding: 4 },
  clearText: { fontSize: 14, color: colors.textMuted },
  searchButton: {
    marginLeft: 10, paddingHorizontal: 16, paddingVertical: 10,
  ...
  emptyIcon: { fontSize: 48, color: colors.accentDim, marginBottom: 16 },
  emptyTitle: { ...fonts.serifBold, fontSize: 22, color: colors.parchment, marginBottom: 8 },
  emptyText: { ...fonts.sansRegular, fontSize: 14, color: colors.textSecondary, textAlign: 'center', lineHeight: 22 },
  suggestions: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', marginTop: 24 },
  suggestionsTitle: { ...fonts.sansRegular, fontSize: 13, color: colors.textMuted, width: '100%', textAlign: 'center', marginBottom: 10 },
  suggestionChip: {
    backgroundColor: colors.surface, borderRadius: borderRadius.round,
    borderWidth: 1, borderColor: colors.surfaceBorder, paddingHorizontal: 16, paddingVertical: 8, margin: 4,
  },
  suggestionText: { ...fonts.sansRegular, fontSize: 13, color: colors.accent },
  resultsList: { paddingBottom: 100 },
  resultsCount: { ...fonts.sansRegular, fontSize: 13, color: colors.textSecondary, paddingHorizontal: spacing.xl, paddingTop: spacing.md, paddingBottom: spacing.sm },
  resultCard: {
    backgroundColor: colors.surface, borderRadius: borderRadius.md,
  ...
  resultIcon: { fontSize: 20, color: colors.accent, marginRight: spacing.md, width: 28, textAlign: 'center' },
  resultInfo: { flex: 1 },
  ...
  matchBadge: { backgroundColor: colors.accentGlow, borderRadius: borderRadius.sm, paddingHorizontal: 8, paddingVertical: 3, marginLeft: 8 },
  matchBadgeText: { ...fonts.sansBold, fontSize: 10, color: colors.accent },
  snippet: { ...fonts.sansRegular, fontSize: 13, color: colors.textSecondary, marginTop: 10, lineHeight: 19, fontStyle: 'italic' },
